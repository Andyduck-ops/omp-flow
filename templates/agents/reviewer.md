...
tools: read, edit, bash, grep, glob, lsp, ast_grep
---
...
- Fix trivial findings inline when operating in the 5b auto-fix loop, then re-run verification for the affected scope.
