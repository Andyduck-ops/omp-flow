 ...
 *
 * Canonical source: `omp-flow-core/channel`. This module is
...
import { buildContextEntries } from "omp-flow-core/channel";
import type { ContextEntry } from "omp-flow-core/channel";
