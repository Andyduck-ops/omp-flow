...
Filter out paths under `.omp-flow/workspace/` and `.omp-flow/tasks/` — those are managed by `add_session.py` and `omp_flow.py task archive` auto-commits and will appear dirty as part of this skill's own work.
