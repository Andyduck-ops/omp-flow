...
- [ ] Update `.omp-flow/spec/guides/` thinking guides
- [ ] Update `.omp-flow/spec/backend/` or `frontend/` docs
...
2. **Sync templates** - After updating `.omp-flow/spec/`, sync to `src/templates/markdown/spec/`
