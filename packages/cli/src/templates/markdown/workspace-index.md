...
```bash
python3 ./.omp-flow/scripts/init_developer.py <your-name>
```
...
1. Get your developer name:
   ```bash
   python3 ./.omp-flow/scripts/get_developer.py
   ```

2. Read your personal index:
   ```bash
   cat .omp-flow/workspace/$(python3 ./.omp-flow/scripts/get_developer.py)/index.md
   ```
