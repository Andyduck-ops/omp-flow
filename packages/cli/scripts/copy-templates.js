 ...
 * - src/templates/omp-flow/ - Workflow scripts and config
 ...
 *
 * Note: We NO LONGER copy from the project's own .omp-flow/, .cursor/, .claude/
 * because those may be customized for the omp-flow project itself.
 */
