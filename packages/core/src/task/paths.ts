 ...
 * `.omp-flow/scripts/common/task_store.py::cmd_create`:
 *
 *     <tasks-dir>/05-13-omp-flow-core-sdk-package/
 *
 * OmpFlow also creates system onboarding tasks during `omp-flow init` using a
...
export interface TaskDirParts {
  /**
   * The directory prefix. Dated tasks use `MM-DD`; OmpFlow system onboarding
   * tasks use `00`.
   */
  prefix: string;
